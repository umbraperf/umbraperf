use arrow::{record_batch::RecordBatch, array::{GenericStringArray, PrimitiveArray, StringArray, Float64Array, Int32Array, UInt64Array}, datatypes::{Float64Type, UInt64Type, Int32Type}};
