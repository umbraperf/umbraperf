use crate::{bindings::notify_js_query_result, state::get_serde_dict, utils::print_to_cons::print_to_js_with_obj, web_file::web_file_chunkreader::WebFileChunkReader};
use arrow::{
